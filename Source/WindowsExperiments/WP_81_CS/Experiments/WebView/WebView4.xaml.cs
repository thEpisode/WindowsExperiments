...
namespace WP_81_CS.Experiments.WebView
{
    ...
    /// </summary>
    public sealed partial class WebView4 : Page
    {
        ...
        public WebView4()
        {
            ...
            this.Loaded += WebView4_Loaded;
        }

        private void WebView4_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            string url = "ms-appx-web:///Experiments/WebView/www/interface.html";
        ...
        private async void Change2ClearColor()
        {
            await myWebView.InvokeScriptAsync("change2ClearColor", null);
        }
